// JavaScript Document
	...
	var swIdentify = true;
	//var urlSVR1 = "http://192.168.10.231:6080/arcgis/rest/services/celsat/SrvInterrup/MapServer/";
	var urlSVR1 = "0000http://201.131.220.47:6080/arcgis/rest/services/celsat/SrvInterrup/MapServer/";	
	var imgPoint = "http://201.131.220.47:6080/images/buffer_point.png";
	var imgmuseo = "http://201.131.220.47:6080/rnm_files/fotos/";
	var geometryService;
	var swBuffer = false;
	...
	function init() {
     ...
     var mapGMapSat = new esri.dijit.Basemap({
		...
		loading = new dojox.widget.Standby({ target:'sbBuffer', color:'#F3F3F3', image:'Content/images/loading.gif'});
		dojo.body().appendChild(loading.domNode);
		loading.startup();
		
		loadingSuperGeo = new dojox.widget.Standby({ target: 'sbShape', color: '#F3F3F3', image: 'Content/images/loading.gif' });
		dojo.body().appendChild(loadingSuperGeo.domNode);
		loadingSuperGeo.startup();
		
		loadingSearch = new dojox.widget.Standby({ target: 'sbSearch', color: '#F3F3F3', image: 'Content/images/loading.gif' });
	  ...
	  {"level" : 23, "resolution" : 0.01866138386, "scale" : 70.53107}
		...
		layers[0] = new esri.layers.FeatureLayer(urlSVR1+"1",{
		                                    mode: esri.layers.FeatureLayer.MODE_ONDEMAND,
											outFields: ["*"]
											//opacity : 1
										  });
							//tooltipLayers[0] = "<b>Museos:</b><br><b>Nombre : </b>${nombre}" <img src="images/SIGDA2.png"> 
		tooltipLayers[0] = "<b>Alimentadores: </b>${CODALIMENTADOR_GFEIT}"
		infoTitle[0] = "Informaci&oacute;n de Alimentadores:"
		var  html_yr_0 = '<div style="height:20px"><div style="float: left; width:45%"><b>Cod. Alimentador GFEIT</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${CODALIMENTADOR_GFEIT}</div></div>';
		    html_yr_0 += '<div style="height:20px"><div style="float: left; width:45%"><b>Cod. Empresa GFEIT</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${CODEMPRESA_GFEIT}</div></div>';
		    html_yr_0 += '<div style="height:20px"><div style="float: left; width:45%"><b>Cod. SET GFEIT</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${CODSET_GFEIT}</div></div>';
			html_yr_0 += '<div style="height:20px"><div style="float: left; width:45%"><b>Tensión Nominal</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${TENSION_NOM}</div></div>';
			html_yr_0 += '<div style="height:20px"><div style="float: left; width:45%"><b>Cod. Relación</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${EMPATE_GFEIT}</div></div>';

		infoContent[0] = html_yr_0;			
		...
		tooltipLayers[1] = "<b>Empresas: </b>${NOM_EMP}"
		infoTitle[1] = "Informaci&oacute;n de Empresa:"	
		var  html_yr_1 = '<div style="height:20px"><div style="float: left; width:45%"><b>Nombre</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${NOM_EMP}</div></div>';
		    html_yr_1 += '<div style="height:20px"><div style="float: left; width:45%"><b>Empresa</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${EMPRESA}</div></div>';

		infoContent[1] = html_yr_1;			
		...
		tooltipLayers[2] = "<b>Sistemas Electricos: </b>${NOMBRESIEL}";
		infoTitle[2] = "Informaci&oacute;n de Sistemas Electricos:"
		var  html_yr_2 = '<div style="height:20px"><div style="float: left; width:45%"><b>Nombre</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${NOMBRESIEL}</div></div>';
		    html_yr_2 += '<div style="height:20px"><div style="float: left; width:45%"><b>Cod. Empresa VNR</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${EMPRESA}</div></div>';
		    html_yr_2 += '<div style="height:20px"><div style="float: left; width:45%"><b>Cod. SIEL</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${CODSIEL}</div></div>';
			html_yr_2 += '<div style="height:20px"><div style="float: left; width:45%"><b>Sector Típico</b></div><div style="float: left; width:50%; border-bottom: 1px ridge;">${SECTOR}</div></div>';

		infoContent[2] = html_yr_2;		
		...
		tooltipLayers[3] = "<b>Sub Estacion de Distribucion: </b>${SED_NOM_SED}";
		infoTitle[3] = "Informaci&oacute;n de Sub Estacion de Distribucion:"
		...
		var  html_yr_3 = '<div style="height:30px"><div style="float: left; width:30%"><b>Titulo</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SED_NOM_SED}</div></div>';
		    html_yr_3 += '<div style="height:30px"><div style="float: left; width:30%"><b>Año</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SED_COD_ANIO}</div></div>';
		    html_yr_3 += '<div style="height:30px"><div style="float: left; width:30%"><b>Semestre</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SED_COD_SEME}</div></div>';
			html_yr_3 += '<div style="height:30px"><div style="float: left; width:30%"><b>Concesionario</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SED_COD_EMP}</div></div>';
			html_yr_3 += '<div style="height:30px"><div style="float: left; width:30%"><b>Alimentador</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SED_COD_ALI}</div></div>';
			html_yr_3 += '<div style="height:30px"><div style="float: left; width:30%"><b>Tensión Nominal (kV) BT</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SED_TEN_NOM_BT}</div></div>';
			html_yr_3 += '<div style="height:30px"><div style="float: left; width:30%"><b>Capacidad Transformación (kVA)</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SED_CAP_TRA}</div></div>';
		...
		tooltipLayers[4] = "<b>Sub Estacion de Transmision: </b>${NOMBRE}";
		infoTitle[4] = "Informacion de Sub Estacion de Transmision:"
		var  html_yr_4 = '<div style="height:30px"><div style="float: left; width:30%"><b>Nombre</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${NOMBRE}</div></div>';
		    html_yr_4 += '<div style="height:30px"><div style="float: left; width:30%"><b>Demanda</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${DEMANDA}</div></div>';
		    html_yr_4 += '<div style="height:30px"><div style="float: left; width:30%"><b>Instalada</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${INSTALADA}</div></div>';
			html_yr_4 += '<div style="height:30px"><div style="float: left; width:30%"><b>Segura</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SEGURA}</div></div>';
			html_yr_4 += '<div style="height:30px"><div style="float: left; width:30%"><b>Servicio</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${SERVICIO}</div></div>';
			html_yr_4 += '<div style="height:30px"><div style="float: left; width:30%"><b>EMPRESA GFEIT</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${EMPRESA_GFEIT}</div></div>';
			html_yr_4 += '<div style="height:30px"><div style="float: left; width:30%"><b>NOMBRE GFEIT</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${NOMBRE_GFEIT}</div></div>';

		infoContent[4] = html_yr_4;		
		...
		// var html_yr_6 = '<div style="height:35px"><div style="float: left; width:30%"><b>Nombre</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${nombre}</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Tipo</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${tipo_admin}</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Direccion</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${direccion}</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Ubicación</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${nomdep} - ${nomprov} - ${nomdist}</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Fecha de fundación</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">0</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Promedio de visitas</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${prom_visit}</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Fuente web</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${fuente_web}</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Fuente link</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${fuente_lin}</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Contacto</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${contacto}</div></div>';
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Telefono</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${telef}</div></div>';
		
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Email</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${email}</div></div>';
		
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Web</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${web}</div></div>';
		
		// html_yr_6 += '<div style="height:35px"><div style="float: left; width:30%"><b>Descripcion</b></div><div style="float: left; width:65%; border-bottom: 1px ridge;">${descrip}</div></div>';
		...
		// html_yr_7 += '<div style="height:25px"><div style="float: left; width:25%"><b>Telefono</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${telf}</div></div>';
       ...
       // var html_yr_8 = '<div style="height:25px"><div style="float: left; width:25%"><b>Nombre</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${titulo}</div></div>';
        ...
        // html_yr_8 += '<div style="height:25px"><div style="float: left; width:25%"><b>Telefono</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${telf}</div></div>';
       ...
       // var html_yr_9 = '<div style="height:25px"><div style="float: left; width:30%"><b>Nombre</b></div><div style="float: left; width:70%; border-bottom: 1px ridge;">${nombre}</div></div>';
        ...
        // layers[10].on("mouse-over", function (evt) {
			...
			// var cod = evt.graphic.attributes.id_cat;
			// var tipo = evt.graphic.attributes.id_ambito;
			// //alert(cod);
			// //alert(tipo);
			
			
			// $.post( "drones.php", { cod: cod, tipo: tipo }).done(function( data ) {
		...
		// layers[11] = new esri.layers.FeatureLayer("http://192.168.56.88:6080/arcgis/rest/services/geocultura/SrvInmaterial/MapServer/0", {
            // //infoTemplate: template,
			// mode: esri.layers.FeatureLayer.MODE_ONDEMAND,
            // outFields: ["*"]
            // //outFields: ["${qAddress}"]
        // });
		// tooltipLayers[11] = "<b>Patrimonia Inmaterial: </b>${provinmat.NOMBPROV}";
		// infoTitle[11] = "Expresiones Cultural:"
       
        // layers[11].on("mouse-over", function (evt) {
			// //var id= "${"+provinmat.NOMBPROV+"}";
			// //var iddep = evt.graphic.attributes.IDPROV;
			// var id = evt.graphic.attributes["provinmat.IDPROV"];
			
			// $.post( "expresiones.php", { id: id }).done(function( data ) {
        ...
        // });
        // layers[11].on("click", function (evt) {
            // if (swIdentify) {
                // showInfo(evt, 11);
            // }
        // })
		//******************TOC*****************************
					...
					/*featLayer1 = new esri.layers.FeatureLayer("http://localhost:6080/arcgis/rest/services/geocultura/SrvGeocultura/MapServer/0", {
							...
							var h = dojo.connect(map, 'onLayersAddResult', function (results) {
							    ...
							    try {
									...
									checked: false
										...
										{
											layer: layers[2],
											title: "Sistemas Electricos"							
										},
										{
											layer: layers[3],
											title: "Sub Estacion de Transmision"							
										},
										{
											layer: layers[4],
											title: "Sub Estacion de Distribucion"							
										}										
										/*, {
                                   layer: dynaLayer1,
						...
						// + " Checked:" + checked);
							...
							// var h4 = dojo.connect(map, 'onLayersAddResult', function (results) {
							    // try {
							        // toc4 = new agsjs.dijit.TOC({
							            // map: map,
							            // layerInfos: [{
							                // layer: layers[11],
							        ...
							        // }, 'tocDiv4');
							        // toc4.startup();
							        // dojo.connect(toc4, 'onTOCNodeChecked', function (rootLayer, serviceLayer, checked) {
							            // if (console) {
							                // console.log("TOCNodeChecked, rootLayer:"
						// + (rootLayer ? rootLayer.id : 'NULL')
						// + ", serviceLayer:" + (serviceLayer ? serviceLayer.id : 'NULL')
...
*/
  ...
  console.log(symbol);
	...
	function search(){ 		  
		...
		queryMAPs.returnGeometry = true;
		queryMAPs.where = "upper(CODALIMENTADOR_GFEIT) like '%" + txt.toUpperCase() + "%'";
		var queryMAPs1 = new esri.tasks.Query();
		queryMAPs1.returnGeometry = true;
		queryMAPs1.where = "upper(NOM_EMP) like '%" + txt.toUpperCase() + "%'";
		var queryMAPs2 = new esri.tasks.Query();
		queryMAPs2.returnGeometry = true;
		queryMAPs2.where = "upper(NOMBRESIEL) like '%" + txt.toUpperCase() + "%'";
		var queryMAPs3 = new esri.tasks.Query();
		queryMAPs3.returnGeometry = true;
		queryMAPs3.where = "upper(SED_NOM_SED) like '%" + txt.toUpperCase() + "%'";
		var queryMAPs4 = new esri.tasks.Query();
		queryMAPs4.returnGeometry = true;
		queryMAPs4.where = "upper(NOMBRE) like '%" + txt.toUpperCase() + "%'";
		...
		layers[0].selectFeatures(queryMAPs, esri.layers.FeatureLayer.SELECTION_NEW, function (results) {
		    ...
		    dojo.forEach(results, function (feature) {
		        data.push({
		            ...
		            //"col3": ' zoomfeature(2, ' + feature.attributes.objectid + '); '
		            "col1": feature.attributes.OBJECTID,
		            "col2": feature.attributes.CODALIMENTADOR_GFEIT,
		            "col3": ' zoomfeature(0, ' + feature.attributes.OBJECTID + '); '
		        }); //alert(feature.attributes.OBJECTID);
		    });
		    
		    var grid = dijit.byId('myDataGrid00');
		    var store = new dojo.data.ItemFileWriteStore({
		        data: {
		            items: data
		        }
		...
		layers[1].selectFeatures(queryMAPs1, esri.layers.FeatureLayer.SELECTION_NEW, function(results){																										
			var data = [];
			dojo.forEach(results, function(feature) {
						data.push({
						    "col1": feature.attributes.OBJECTID,
							"col2": feature.attributes.NOM_EMP,
							"col3": ' zoomfeature(1, ' + feature.attributes.OBJECTID + '); '
						});
					});
			var grid = dijit.byId('myDataGrid01');		 	
			var store = new dojo.data.ItemFileWriteStore({
				data: {
					items: data
				}
		...
		layers[2].selectFeatures(queryMAPs2, esri.layers.FeatureLayer.SELECTION_NEW, function(results){																										
			var data = [];
			dojo.forEach(results, function(feature) {
						data.push({
						    "col1": feature.attributes.OBJECTID,
							"col2": feature.attributes.NOMBRESIEL,
							"col3": ' zoomfeature(2, ' + feature.attributes.OBJECTID + '); '
						});
					});
			var grid = dijit.byId('myDataGrid02');		 	
			var store = new dojo.data.ItemFileWriteStore({
				data: {
					items: data
				}
 		...
 		layers[3].selectFeatures(queryMAPs3, esri.layers.FeatureLayer.SELECTION_NEW, function(results){																										
			var data = [];
			dojo.forEach(results, function(feature) {
						data.push({
						    "col1": feature.attributes.OBJECTID,
							"col2": feature.attributes.SED_NOM_SED,
							"col3": ' zoomfeature(3, ' + feature.attributes.OBJECTID + '); ' 
						});
					});
			var grid = dijit.byId('myDataGrid03');		 	
			var store = new dojo.data.ItemFileWriteStore({
				data: {
					items: data
				}
		...
		layers[4].selectFeatures(queryMAPs4, esri.layers.FeatureLayer.SELECTION_NEW, function(results){																										
				var data = [];
				dojo.forEach(results, function(feature) {
							data.push({
							    "col1": feature.attributes.OBJECTID,
							    "col2": feature.attributes.NOMBRE,
							    "col3": ' zoomfeature(4, ' + feature.attributes.OBJECTID + '); '
							});
						});
			var grid = dijit.byId('myDataGrid04');		 	
			var store = new dojo.data.ItemFileWriteStore({
				data: {
					items: data
				}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function zoomfeature(lry, id){
		...
		switch (lry){
	        ...
	        break;
	        case 3:
				layers[3].selectFeatures(query, esri.layers.FeatureLayer.SELECTION_NEW,function(features){
					var stateExtent = features[0].geometry.getExtent().expand(5.0);
					map.setExtent(stateExtent);
					featureSelected = new esri.Graphic(features[0].geometry,highlightSymbol);
					map.graphics.add(featureSelected);  			
	...
	function ubigeo(lyr){
		var lyrQuery = new esri.tasks.QueryTask(urlSVR1 + lyr);
		var query = new esri.tasks.Query();
    ...
    switch (lyr) {
        case 3:
            ...
            lyrQuery.execute(query, function (results) {
                ...
                var queryTask2 = new esri.tasks.QueryTask(urlSVR1 + "2");
                ...
                queryTask2.execute(query2, function (results2) {
                    ...
                    var queryTask1 = new esri.tasks.QueryTask(urlSVR1 + "1");
                    ...
                    queryTask1.execute(query1, function (results1) {
                        ...
                        var queryTask0 = new esri.tasks.QueryTask(urlSVR1 + "0");
