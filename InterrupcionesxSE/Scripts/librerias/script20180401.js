...
var navToolbar, toolbar, basemapGallery, highlightSymbol, highlightSymbol1, lengthParams, areaParams, symbol_Buffer, symbol_radio, featureSelected, legendDijit, toc, featLayer1, toc1;
...
function Extend(extent) {
    ...
    yMax = map.extent.ymax;*/
        ...
        xMax = -86.220025;
        yMax = 37.006985;
        //xmin": -97.968323, "ymin": 32.405333, "xmax": -86.220025, "ymax": 37.006985			
        swExtend = true;
    }
}
...
function zoomExtend() {
    var extent = new esri.geometry.Extent({ xmin: -94.7015998444392, ymin: -20.26654382435, xmax: -55.276, ymax: 2.875, spatialReference: { wkid: 4326 } })
