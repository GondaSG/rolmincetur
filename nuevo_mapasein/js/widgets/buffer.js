define([
  ...
  var _gly_sketchbuffer = new GraphicsLayer({
    ...
    _gly_buffer = new GraphicsLayer({
      listMode: "hide",
      title: 'Buffer'
    }),

    _gly_searchbuffer = new GraphicsLayer({
      listMode: "hide",
  ...
  function initBuffer(){
    ...
    _sketchviewmodel.on(["update"], function (event) {
      ...
      // Actualice el filtro cada vez que el usuario mueva el __buffergeometry
  ...
  $('#wg_buffer').on('click', '.btn-limpiar', function () {
  ...
  $('#wg_buffer').on('click', '.btn-close', function (event) { 
    event.preventDefault();
    $('#lbl_titletool').text('Área de influencia');
    $('#modalcleartool').modal('show');
    $('#btn_yescleartool').removeClass().addClass('btn-confirm wg-buffer');
  });
  
  //Evento lanzado al confirmar el cerrar (limpiar)
  $('#modalcleartool').on('click', '#btn_yescleartool.wg-buffer', function (event) {
    $('#btn_yescleartool').removeClass('wg-buffer');
    $containertbl.removeClass('visible').addClass('notvisible');
    $('#wg_buffer .btn-dibujar').removeClass('active');
    $('#modalcleartool').modal('hide');
    clearAllOperation();

    $('#wg_buffer').removeClass("visible").addClass("notvisible");
  });
