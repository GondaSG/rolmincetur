...
public class VuceTemplateApplication {
...
//	  
//	  sessionFactoryBean.setDataSource(dataSource); Properties hibernateProperties
//	  = new Properties(); hibernateProperties.put("hibernate.dialect",
//	  HIBERNATE_DIALECT); hibernateProperties.put("hibernate.show_sql",
//	  HIBERNATE_SHOW_SQL); hibernateProperties.put("hbm2ddl.auto", "update");
